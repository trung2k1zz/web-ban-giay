                ...
                <div id="woot-rate-alert">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo esc_attr_e($link) ?>" target="_blank" class="woot-panel-button dashicons-before dashicons-star-filled">&nbsp;<?php echo __('Ok, you deserve it', 'profit-products-tables-for-woocommerce') ?></a>
                            </td>
